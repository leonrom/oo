        ...
        saved = {
            ...
            Act: (pO5, typ) => {
                ...
                if (sl.pO5 && sl.pO5 !== pO5) { // заканчиваю предыдущую цепочку скроллингов
                    if (debug > 2)
                        console.log("%c%s", C.fmtOK, `scroll ${sl.pO5.cnst.id}: `, ' закончил!')
                ...
                if (
                    ...
                    if (debug > 2)
                        console.log("%c%s", C.fmtOK, `saved ${pO5.cnst.id}: ${typ === 'S' ? 'скроллинг' : 'размеры'} ` +
                    ...
                    if (window.olga7.canDoScroll) {
                        window.olga7.canDoScroll = false
                        blks = false
                    }
