...
class OO5 {
    ...
    #SetaO5 = b5 => {
        ...
        window.olga7.shp.DoInit.ReadAttrs(aO5)
        ...
        if (o_debug)
            console.log("%c%s", TMove.fmOK, TMove.head, `изменено ${aO5.name}`)
        this.#BordNames(aO5)
    ...
    InitShp = () => {
        ...
        // this.wshp = window.olga7.shp
        this.C = window.olga7.C
        o_debug = this.C.consts.debug
        ...
        window.addEventListener('o_activate', this.Activate)
        window.addEventListener('o_testActFix', this.ActFix)
...
window.addEventListener('o_isInited', oo5.InitShp)
